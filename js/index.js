...
function showCode(token)
{
    ...
    <textarea style='width: 100%;'>\
        <iframe scrolling='no' src='https://chaipokoi.github.io/Pokemon-Go-WebAPI/embed.html?params="+token+"' style='width: 100%; height: 140px; overflow: hidden; border:none;' scrolling='NO'></iframe>\
    </textarea>";
